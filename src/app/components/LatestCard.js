...
const LatestCard = () => {
  return (
    <div className="overflow-hidden rounded shadow-lg bg-slate-200">
        ...
        <div className='flex justify-between storebutton'>
          <div className='text-black '>
            <div className='flex justify-center'>
              <GiSteeringWheel className='mb-2 text-xl' />
            </div>
            Jondeer
          </div>
          <div className='text-black'>
            <div className='flex justify-center'>
              <MdCarRental className='mb-2 text-xl' />
            </div>
            $30 / day
          </div>
          <div className='text-black'>
            <div className='flex justify-center'>
              <WiTime3 className='mb-2 text-xl' />
            </div>
            6 days
          </div>
          <div className='text-black'>
            <div className='flex justify-center'>
              <FaGasPump className='mb-2 text-xl' />
            </div>
            30 Gallons
          </div>
